...
class _HomeState extends State<Home> {
  ...
  List<String> cities = ['London']; //the list to hold our selected cities. Deafult is London

  List consolidatedWeatherList = []; //To hold our weather data after api call

  //Api calls url
  String searchLocationUrl = 'https://www.metaweather.com/api/location/search/?query='; //To get the woeid
  ...
  void fetchWeatherData() async{
    ...
    setState(() {
      ...
      consolidatedWeatherList = consolidatedWeather.toSet().toList(); //Remove any instances of dublicates from our
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  weatherItem(text: 'Wind Speed', value: maxTemp, unit: 'C', imageUrl: 'assets/max-temp.png',),
                ],
              ),
            ),
            const SizedBox(height: 50,),
            ...
            Expanded(child: ListView.builder(
              scrollDirection: Axis.horizontal,
                ...
                itemBuilder: (BuildContext context, int index){
                  ...
                  var parsedDate = DateTime.parse(consolidatedWeatherList[index]['applicable_date']);
                  var newDate = DateFormat('EEEE').format(parsedDate).substring(0, 3); //formateed date
                  ...
                  return GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text(consolidatedWeatherList[index]['the_temp'].round().toString()+ "C", style: TextStyle(
                            fontSize: 17,
